                    ...
                    <div class="form-card" style="box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.5);">
                        ...
                        <div style="position: relative; z-index: 10;">
                            ...
                            if (isset($_SESSION['success'])) {
                                echo '<div style="background: rgba(16, 185, 129, 0.2); color: #6ee7b7; padding: 1rem; border-radius: 0.75rem; border: 1px solid rgba(16, 185, 129, 0.3); margin-bottom: 1.5rem; text-align: center; font-size: 0.875rem;">' . $_SESSION['success'] . '</div>';
