            ...
            <section class="contact-hero container section">
                ...
                <div class="contact-grid">
                    ...
                    <div class="form-card" style="transition-delay: 200ms;">
                        ...
                        <?php if ($success): ?>
                            <div style="background: rgba(16, 185, 129, 0.2); color: #6ee7b7; padding: 1rem; border-radius: 0.75rem; border: 1px solid rgba(16, 185, 129, 0.3); margin-bottom: 2rem; font-size: 1rem; margin-top: 1.5rem;"><?php echo $success; ?></div>
                        <?php endif; ?>
                        <?php if ($error): ?>
                            <div style="background: rgba(239, 68, 68, 0.2); color: #fca5a5; padding: 1rem; border-radius: 0.75rem; border: 1px solid rgba(239, 68, 68, 0.3); margin-bottom: 2rem; font-size: 1rem; margin-top: 1.5rem;"><?php echo $error; ?></div>
                        <?php endif; ?>
                        <form action="contact.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" placeholder="jane@example.com" class="form-control" required value="<?php echo is_logged_in() ? htmlspecialchars($_SESSION['username'] . '@example.com') : ''; ?>" />
                            </div>
